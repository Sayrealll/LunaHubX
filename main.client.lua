...
function utility:init()
    ...
    if not identifyexecutor then
        self.LocalPlayer:Kick("Unsupported executor missing identifyexecutor")
        return false
    end

    local exc = identifyexecutor():lower()
    if exc:find("xeno") or exc:find("solara") then
        self.LocalPlayer:Kick("Unsupported executor")
        return false
    end
